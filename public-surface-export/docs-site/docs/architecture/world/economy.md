...
Models deterministic economic state, ledgers, settlement, treasury windows, and budget execution.

## Responsibilities

- Own the canonical description of economy within the architecture book.
...
- economy_runtime.
- economic_runtime in host.
- everarcade-economy-sdk.
- economic tests and reports.
...
Partial; no mainnet settlement guarantee.
