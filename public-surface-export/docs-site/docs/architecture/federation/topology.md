...
Tracks peer membership, capability, trust scope, execution assignments, and federation windows.

## Responsibilities

- Own the canonical description of topology within the architecture book.
...
- topology/topology_state/lease/peer.
- discovery and peer registry modules.
- federation_network topology and scheduler.
- task_coordination and distributed_execution assignment modules.
...
Partial; topology is modeled and tested, not yet a full production control plane.
