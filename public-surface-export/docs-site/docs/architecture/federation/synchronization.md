...
Moves receipts, checkpoints, bundles, and replay windows between peers.

## Responsibilities

- Own the canonical description of synchronization within the architecture book.
...
- sync_engine, incremental_sync, checkpoint_sync.
- host distributed_sync and federation_transport.
- receipt range transfer and resumable sync tests.
- runtime wan_recovery modules.
...
Partial operational foundation.
