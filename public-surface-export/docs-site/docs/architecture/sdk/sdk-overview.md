...
Explains SDK crates that help developers build games, worlds, bridges, simulations, economies, entities, and governance logic.

## Responsibilities

- Own the canonical description of sdk overview within the architecture book.
...
- sdk/everarcade-sdk.
- world/entity/simulation/economy/governance SDKs.
- client-bridge.
- validation harness.
...
Partial; APIs should be treated as evolving.
