...
Creates, validates, transfers, restores, and reconciles state snapshots.

## Responsibilities

- Own the canonical description of checkpoint system within the architecture book.
...
- execution-core checkpoint modules.
- everarcade-host checkpoint_store and checkpoint_sync.
- runtime node checkpoint validation and bootstrap restoration.
- test vectors and checkpoint transfer tests.
...
Implemented foundation; storage backends and operator automation are partial.
