...
Records every authoritative transition as verifiable evidence.

## Responsibilities

- Own the canonical description of receipt system within the architecture book.
...
- ExecutionReceipt in ABI and receipt_runtime modules.
- receipt_chain links receipts.
- receipt_root summarizes windows.
- signed_receipt and distributed_receipts host modules propagate receipts.
...
Implemented foundation; distributed stores and publication are operationally partial.
