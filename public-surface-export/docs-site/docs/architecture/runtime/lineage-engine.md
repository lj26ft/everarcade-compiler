...
Maintains continuity chains that explain how execution, world, checkpoint, and civilization histories connect.

## Responsibilities

- Own the canonical description of lineage engine within the architecture book.
...
- lineage chain/continuity/errors.
- continuity modules in host and execution-core.
- archive and compression roots.
- execution_lineage and assignment_lineage modules.
...
Implemented for validation and recovery reasoning; production archival policy remains roadmap.
