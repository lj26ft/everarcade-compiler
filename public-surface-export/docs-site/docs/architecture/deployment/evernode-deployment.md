...
Describes provider deployment, peer manifests, capacity advertisement, state folders, and anchoring intents.

## Responsibilities

- Own the canonical description of evernode deployment within the architecture book.
...
- everarcade-host evernode modules.
- provider-evernode crate.
- docs/evernode-*.
- XRPL/Xahau gateway and anchoring modules.
...
Partial; provider readiness reports identify gaps.
