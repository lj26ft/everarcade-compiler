...
Gives operators recovery paths for checkpoints, machine rejoin, transport failure, rollback, and divergence.

## Responsibilities

- Own the canonical description of operational recovery within the architecture book.
...
- docs/runbooks.
- host recovery and runtime_recovery.
- runtime node recovery modules.
