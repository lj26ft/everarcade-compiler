...
Focus the first release on local deterministic execution, receipts, replay, package loading, docs, and operator-safe recovery.

## Responsibilities

- Own the canonical description of v0.1 roadmap within the architecture book.
...
- Freeze ABI v0.1 inputs/outputs and receipt fields.
- Guarantee local replay for package fixtures.
- Ship package format, quickstart, and recovery docs.
- Classify federation and renderer as non-authoritative scaffold unless explicitly validated.
- Add targeted CI gates for execution-core, host package loading, and replay.
...
v0.1 should optimize for correctness, reproducibility, and contributor onboarding over broad product scope.
