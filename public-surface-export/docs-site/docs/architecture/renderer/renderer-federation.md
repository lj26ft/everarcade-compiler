...
Replicates projection artifacts for observers without changing authority roots.

## Responsibilities

- Own the canonical description of renderer federation within the architecture book.
...
- renderer-client federation modules.
- projection federation validation reports.
- observer service/runtime/stream modules.
- federation equivalence checks.
