...
pub fn world_spawn(input: Input, state: State) -> Result<Output, Error> {
    apply_named("world.spawn", input, state)
}
pub fn world_despawn(input: Input, state: State) -> Result<Output, Error> {
    apply_named("world.despawn", input, state)
}
