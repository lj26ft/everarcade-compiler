...
pub fn structure_build(input: Input, state: State) -> Result<Output, Error> {
    apply_named("structure.build", input, state)
}
pub fn structure_decay(input: Input, state: State) -> Result<Output, Error> {
    apply_named("structure.decay", input, state)
}
pub fn structure_repair(input: Input, state: State) -> Result<Output, Error> {
    apply_named("structure.repair", input, state)
}
