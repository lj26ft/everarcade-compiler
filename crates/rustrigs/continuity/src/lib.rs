...
pub fn continuity_advance(input: Input, state: State) -> Result<Output, Error> {
    apply_named("continuity.advance", input, state)
}
pub fn continuity_record_event(input: Input, state: State) -> Result<Output, Error> {
    apply_named("continuity.record_event", input, state)
}
pub fn continuity_create_ruin(input: Input, state: State) -> Result<Output, Error> {
    apply_named("continuity.create_ruin", input, state)
}
