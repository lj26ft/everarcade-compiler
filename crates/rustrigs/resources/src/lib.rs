...
pub fn resource_harvest(input: Input, state: State) -> Result<Output, Error> {
    apply_named("resource.harvest", input, state)
}
pub fn resource_regenerate(input: Input, state: State) -> Result<Output, Error> {
    apply_named("resource.regenerate", input, state)
}
