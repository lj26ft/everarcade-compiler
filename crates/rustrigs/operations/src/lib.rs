...
pub fn operation_checkpoint(input: Input, state: State) -> Result<Output, Error> {
    apply_named("operation.checkpoint", input, state)
}
pub fn operation_restore(input: Input, state: State) -> Result<Output, Error> {
    apply_named("operation.restore", input, state)
}
pub fn operation_migrate(input: Input, state: State) -> Result<Output, Error> {
    apply_named("operation.migrate", input, state)
}
