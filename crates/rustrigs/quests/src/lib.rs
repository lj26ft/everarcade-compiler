...
pub fn quest_start(input: Input, state: State) -> Result<Output, Error> {
    apply_named("quest.start", input, state)
}
pub fn quest_progress(input: Input, state: State) -> Result<Output, Error> {
    apply_named("quest.progress", input, state)
}
pub fn quest_complete(input: Input, state: State) -> Result<Output, Error> {
    apply_named("quest.complete", input, state)
}
