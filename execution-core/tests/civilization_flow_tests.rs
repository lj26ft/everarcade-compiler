...
fn same_genesis_same_package_roots() {
    let g = CivilizationGenesis { civilization_id: h(1), domain_root: h(2), constitution_root: h(3), treasury_root: h(4), fiscal_root: h(5), monetary_root: h(6), asset_root: h(7) };
