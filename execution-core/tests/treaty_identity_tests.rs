...
fn treaty_identity_is_deterministic() {
    let treaty = ExecutionTreaty { treaty_id: [1; 32], participating_domains: vec![[2; 32], [3; 32]], constitutional_scope_root: [4; 32], capability_scope_root: [5; 32], arbitration_root: [6; 32] };
