...
impl FinalityTracker {
    ...
    pub fn finalize_if_window_elapsed(&mut self, now_block: u64, challenge_window_blocks: u64) -> bool {
        match self.accepted_at_block {
            Some(accepted_at) if now_block.saturating_sub(accepted_at) >= challenge_window_blocks => {
