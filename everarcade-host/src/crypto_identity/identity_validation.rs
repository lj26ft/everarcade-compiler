...
use super::{node_identity::CryptographicNodeIdentity, peer_fingerprint::derive_peer_fingerprint, signed_manifest::SignedIdentityManifest};
...
pub fn validate_manifest(manifest: &SignedIdentityManifest) -> bool {
    manifest.manifest_root != [0; 32] && manifest.signer_root != [0; 32] && manifest.signature_root != [0; 32]
}
