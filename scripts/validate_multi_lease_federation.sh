...
REPORT_PATH="$REPORT_DIR/multi_lease_federation_validation_report.txt"
...
Multi-Lease Federation Validation Report
...
Multi-Lease Federation Validation: $overall_status
REPORT
