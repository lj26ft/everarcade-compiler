...
REPORT_PATH="$REPORT_DIR/developer_portal_validation_report.txt"
...
validate_game_creation && game_creation_status="PASS"
...
Developer Portal Validation Report
Version: $DEVELOPER_PORTAL_VERSION
Portal ID: $DEVELOPER_PORTAL_ID
Authority: $DEVELOPER_PORTAL_AUTHORITY
Ordering: $DEVELOPER_PORTAL_ORDERING
Settlement Mode: $DEVELOPER_PORTAL_SETTLEMENT_MODE
Private Key Custody: $DEVELOPER_PORTAL_PRIVATE_KEY_CUSTODY

Projects: $projects_status
Game Creation: $game_creation_status
...
Developer Portal Validation: $overall_status
REPORT
