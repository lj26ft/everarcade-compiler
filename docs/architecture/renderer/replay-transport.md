...
Delivers replay/projection data to observers and renderer clients while preserving verification metadata.

## Responsibilities

- Own the canonical description of replay transport within the architecture book.
...
- renderer history observer stream modules.
- federation transport and replay transport reports.
- client playback and event view.
- archive hydration modules.
...
Scaffold-level; not authoritative.
