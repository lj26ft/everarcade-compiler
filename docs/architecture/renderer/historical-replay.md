...
Lets clients inspect prior windows, branches, archives, and materialized eras.

## Responsibilities

- Own the canonical description of historical replay within the architecture book.
...
- renderer-client history modules.
- host archive/query/compression_runtime.
- tools replay visualizer/debugger.
- historical archive and corruption reports.
...
Scaffold-to-partial; UX and storage policy are roadmap.
