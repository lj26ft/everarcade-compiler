...
Converts authoritative runtime facts into non-authoritative frames, event views, HUDs, and renderer state.

## Responsibilities

- Own the canonical description of projection runtime within the architecture book.
...
- render_bridge/render_projection modules.
- runtime/client projection_service and world_view.
- runtime/renderer-client renderers and persistence.
- world projection reports.
