...
Recomputes execution and compares roots, receipts, snapshots, windows, and projections.

## Responsibilities

- Own the canonical description of replay engine within the architecture book.
...
- execution-core replay and replay_runtime modules.
- everarcade-host replay_engine, replay_sync, runtime_replay.
- test vectors for replay consensus, history, identity, and verifier sync.
- tools/replay-debugger and replay-visualizer.
...
Production validation foundation; long-horizon UX is still evolving.
