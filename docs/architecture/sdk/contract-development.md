...
Defines deterministic contract ABI expectations and package boundaries.

## Responsibilities

- Own the canonical description of contract development within the architecture book.
...
Foundation implemented; package registry and compatibility policies must mature.
