...
Describe the production target for an operated, federated, recoverable EverArcade network.

## Responsibilities

- Own the canonical description of v1 roadmap within the architecture book.
...
- Production persistence and archival policy.
- Signed package registry and compatibility governance.
- Federation topology control, WAN hardening, and reconciliation automation.
- Evernode provider deployment with observability and rollback.
- Non-authoritative renderer projection and historical replay products.
...
v1 should promote only validated runtime paths and keep experimental domains behind explicit maturity labels.
