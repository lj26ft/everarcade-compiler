...
Hosts persistent world state above deterministic execution primitives.

## Responsibilities

- Own the canonical description of world runtime within the architecture book.
...
- world_runtime runtime/tick/world/continuity/recovery/validation.
- civilization_runtime in host.
- world reports for persistent runtime and restoration.
- examples and templates for worlds.
...
Operational foundation with significant scaffold domains.
