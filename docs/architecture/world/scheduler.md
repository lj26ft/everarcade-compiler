...
Orders world ticks, lanes, entities, events, ownership, migration, and checkpoint boundaries.

## Responsibilities

- Own the canonical description of scheduler within the architecture book.
...
- world_scheduler modules.
- scheduler and simulation_scheduler.
- host civilization_scheduler and governance_scheduler.
- lane scheduling reports.
...
Implemented in model form; production load policy is evolving.
