...
Tracks deterministic items, ownership, transfers, and validation for game/world assets.

## Responsibilities

- Own the canonical description of inventory within the architecture book.
...
- inventory_runtime item/ownership/transfer.
- inventory renderer and SDK surfaces.
- rustrigs inventory package.
- community registry inventory entries.
