...
Provides deterministic AI, ecology, society, gameplay, and world simulation layers.

## Responsibilities

- Own the canonical description of simulation within the architecture book.
...
- simulation and world_simulation modules.
- civilization/ecology/faction/society runtimes.
- sdk simulation SDK.
- tools simulation-debugger.
...
Partially implemented; many reports are validation milestones.
