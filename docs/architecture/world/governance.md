...
Models proposals, quorum, treaties, laws, diplomacy, conflict, and validation windows.

## Responsibilities

- Own the canonical description of governance within the architecture book.
...
- governance_runtime.
- governance_security and governance_sync.
- federation_security signed treaty modules.
- governance SDK and tests.
...
Partial; protocol model exists, real governance ops remain roadmap.
