...
- Project, world, template, clone, and checkpoint semantics are covered by deterministic workflow hashes and restore points.
- Serialization readiness depends on stable hashes rather than host-local timestamps.
- Restore operations preserve replay-safe checkpoints.
