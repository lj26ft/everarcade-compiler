# Terrain Authoring Report

## Creator readiness

- Raise, lower, smooth, flatten, paint, and seeded noise tools operate over stable terrain cells.
- Circle, square, falloff, and custom brushes enumerate affected cells deterministically.
- Region, partition, biome, civilization territory, resource, and spawn metadata painting produces sorted deterministic metadata.
