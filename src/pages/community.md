...
```mermaid
flowchart LR
  XRPL[XRPL] --> Anchoring[Anchoring and public references]
  Xahau[Xahau] --> Anchoring
  Evernode[Evernode] --> Operators[World Operators]
  Developers[Developers] --> Worlds[EverArcade Worlds]
  Operators --> Worlds
  Players[Players] --> Worlds
  Contributors[Open Source Contributors] --> Developers
  Contributors --> Operators
  Worlds --> History[Verifiable World History]
```
