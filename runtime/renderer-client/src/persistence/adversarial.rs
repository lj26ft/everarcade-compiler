...
pub fn detect_frame_ordering_corruption(artifacts: &[RenderProjectionArtifact]) -> Result<(), String> {
...
pub fn detect_duplicate_artifact_insertion(artifacts: &[RenderProjectionArtifact]) -> Result<(), String> {
...
pub fn detect_transport_replay_injection(envelopes: &[ProjectionTransportEnvelope]) -> Result<(), String> {
    let mut seen = HashSet::new();
    for e in envelopes {
