module.exports = {
  docs: [
    ...
    { type: 'category', label: 'Concepts', items: ['concepts/index', 'concepts/what-is-a-world', 'concepts/world-contract', 'concepts/continuity-engine', 'concepts/why-everarcade-is-different', 'concepts/sovereign-worlds', 'concepts/rustrigs'] },
