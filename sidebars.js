module.exports = {
  docs: [
    ...
    { type: 'category', label: 'Operators', items: ['operators/index', '13-runtime-operations-manual', 'architecture/federation/federation-runtime', 'runtime/replay_verification', 'checkpoint-recovery', 'operator-recovery'] },
